...
main_session = MainDbSession()._session_instance
pdf_session = PdfDbSession()._session_instance
...
class MainDocumentTypeFactory(factory.alchemy.SQLAlchemyModelFactory):
    ...
    id = factory.Faker("numerify", text="#" * 32)
...
class PDFIngestionEventFactory(factory.alchemy.SQLAlchemyModelFactory):
    ...
    parsing_strategy_type_id = fuzzy.FuzzyChoice(
        ["9720cb1c-4461-40e4-b800-38dfdfd0061b"]
    )
